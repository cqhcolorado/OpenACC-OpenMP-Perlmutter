...
!  call ftcamp
  ...
  load_tm=load_tm/numprocs
    ...
    write(*,*),'total_tm',total_tm,'poisson_tm',poisson_tm,'ppush_tm',ppush_tm,'cpush_tm',cpush_tm,'pmove_tm',pmove_tm,'grid1_tm',grid1_tm,'others',total_tm-poisson_tm-ppush_tm-cpush_tm-pmove_tm
